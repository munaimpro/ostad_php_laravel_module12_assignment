                    ...
                    <div class="container mx-auto mt-2 p-2 bg-white rounded-lg">
                        <div class="row justify-content-center">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <h2 class="mb-0">All Bus List</h2>
                                <div class="right">
                                    <button type="button" class="btn btn-info btn-lg" data-bs-toggle="modal" data-bs-target="#busModal">Add New Bus</button>
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th>Coach Name</th>
                                        <th>Coach Type</th>
                                        <th>Total Seats Allocation</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @forelse ($busList as $i => $bus)
                                        <tr>
                                            <td>{{ $i + 1 }}</td>
